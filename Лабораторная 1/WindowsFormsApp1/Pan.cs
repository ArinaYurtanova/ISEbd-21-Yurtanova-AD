...
namespace WindowsFormsApp1
{
    class Pan
    {
        ...
        {
            wine = new Wine[countWine];
        }
        public void Init1(int countJuice)
        {
            orangeJuice = new OrangeJuice[countJuice];
        }
        ...
        public void GetHeat()
        {
            ...
            if (orangeJuice.Length > 0)
            {
                for (int i = 0; i < orangeJuice.Length; i++)
                {
                    orangeJuice[i].GetHeat();
                }
                bool flag = false;
                switch (orangeJuice[0].Temperature)
                {
                    case 20: flag = true; break;
                    case 40: flag = true; break;
                    case 60: flag = true; break;
        ...
        public bool IsReady()
        {
            ...
            for (int i = 0; i < orangeJuice.Length; i++)
            {
                if (orangeJuice[i].Temperature < 100)
                {
                    return false;
                }
            }
